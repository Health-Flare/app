...
class AppointmentQuestionIsar {
  late String questionId; // client-generated UUID string
...
class MedicationChangeIsar {
  late String changeId; // client-generated UUID string
  late String description;
  int? linkedMedicationIsarId; // if wired to a MedicationIsar row
}
