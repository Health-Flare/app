...
class _FirstLogPromptState extends ConsumerState<FirstLogPrompt> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      // Scrolls internally so this step is safe to render at any height,
      // regardless of whether the caller wraps it in a scroll view.
            ...
            Column(
              children: [
                ...
                GridView.count(
                  ...
                  // anything above ~1.15 clips on narrow screens or at
                  // larger text sizes.
