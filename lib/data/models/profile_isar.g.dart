...
extension ProfileIsarQueryWhere
  ...
  QueryBuilder<ProfileIsar, ProfileIsar, QAfterWhereClause> idGreaterThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProfileIsar, ProfileIsar, QAfterWhereClause> idLessThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ProfileIsarQuerySortBy
  ...
  QueryBuilder<ProfileIsar, ProfileIsar, QAfterSortBy> sortByColorSeedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProfileIsarQuerySortThenBy
  ...
  QueryBuilder<ProfileIsar, ProfileIsar, QAfterSortBy> thenByColorSeed() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorSeed', Sort.asc);
    });
  }
