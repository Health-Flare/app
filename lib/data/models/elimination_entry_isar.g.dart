...
const EliminationEntryIsarSchema = CollectionSchema(
  ...
  properties: {
    r'blood': PropertySchema(id: 0, name: r'blood', type: IsarType.bool),
    ...
    r'urgency': PropertySchema(id: 8, name: r'urgency', type: IsarType.bool),
  },
...
extension EliminationEntryIsarQueryFilter
    on
        QueryBuilder<
  ...
  >
  bloodEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'blood', value: value),
      );
    });
  }
  ...
  bristolTypeIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'bristolType'),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  bristolTypeIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'bristolType'),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  bristolTypeEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'bristolType', value: value),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  bristolTypeGreaterThan(int? value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  bristolTypeLessThan(int? value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  urgencyEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'urgency', value: value),
      );
    });
  }
}

extension EliminationEntryIsarQueryObject
    on
        QueryBuilder<
          EliminationEntryIsar,
          EliminationEntryIsar,
...
extension EliminationEntryIsarQueryLinks
    on
        QueryBuilder<
          EliminationEntryIsar,
          EliminationEntryIsar,
...
extension EliminationEntryIsarQueryProperty
    on
        QueryBuilder<
          EliminationEntryIsar,
          EliminationEntryIsar,
