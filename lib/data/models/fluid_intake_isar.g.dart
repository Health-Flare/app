...
const FluidIntakeIsarSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'volumeMl': PropertySchema(id: 5, name: r'volumeMl', type: IsarType.long),
  },
...
extension FluidIntakeIsarQueryFilter
  ...
  drinkTypeIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'drinkType'),
      );
    });
  }
  ...
  drinkTypeIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'drinkType'),
      );
    });
  }

  QueryBuilder<FluidIntakeIsar, FluidIntakeIsar, QAfterFilterCondition>
  drinkTypeEqualTo(String? value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<FluidIntakeIsar, FluidIntakeIsar, QAfterFilterCondition>
  drinkTypeStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<FluidIntakeIsar, FluidIntakeIsar, QAfterFilterCondition>
  drinkTypeEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  drinkTypeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'drinkType', value: ''),
      );
    });
  }
  ...
  drinkTypeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'drinkType', value: ''),
      );
    });
  }
  ...
  volumeMlEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'volumeMl', value: value),
      );
    });
  }

  QueryBuilder<FluidIntakeIsar, FluidIntakeIsar, QAfterFilterCondition>
  volumeMlGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<FluidIntakeIsar, FluidIntakeIsar, QAfterFilterCondition>
  volumeMlLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
...
extension FluidIntakeIsarQueryWhereDistinct
  ...
  QueryBuilder<FluidIntakeIsar, FluidIntakeIsar, QDistinct>
  distinctByDrinkType({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
