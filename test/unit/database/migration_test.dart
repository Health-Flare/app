...
void main() {
  ...
  group('MigrationRunner', () {
    test('fresh install: schemaVersion reaches target (v12)', () async {
      ...
      expect(settings!.schemaVersion, 12);
    });
    ...
    test(
      ...
      () {
        ...
        // on the target version. Both hardcode v12 — this test would fail if
        // one is updated without the other.
        //
        // The target version is verified by the migration reaching v12 in the
